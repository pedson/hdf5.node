    ...
    public:
        ...
        static void read_dataset (const v8::FunctionCallbackInfo<Value>& args)
        {
            ...
            if(args.Length() == 3){
                ...
                //std::cout << "length " << start.size() << std::endl;
            ...
            switch(class_id)
            {
                ...
                default:
                    ...
                    object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "rank"), Number::New(v8::Isolate::GetCurrent(), rank));
                    switch(rank)
                {
                    case 3:
        ...
        static void readDatasetAsBuffer (const v8::FunctionCallbackInfo<Value>& args)
        {
            ...
            switch(class_id)
            {
                ...
                case H5T_BITFIELD:
                {
                    ...
                    object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "type"), Int32::New(v8::Isolate::GetCurrent(), etype));
                    H5Tclose(t);
                    if(subsetOn){
                        H5Sclose (memspace_id);
                        H5Sclose (dataspace_id);
                    ...
                    {
                        case 4:
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "rows"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[3]));
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "columns"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[2]));
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "sections"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[1]));
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "pages"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[0]));
                            break;
                        case 3:
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "rows"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[2]));
                            object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "columns"), Number::New(v8::Isolate::GetCurrent(), values_dim.get()[1]));
                    ...
                    object->Set(String::NewFromUtf8(v8::Isolate::GetCurrent(), "buffer"), buffer);
                    args.GetReturnValue().Set(object);
                }
                    break;
                default:
